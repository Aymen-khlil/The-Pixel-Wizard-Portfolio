...
const AboutMeContent = () => {
  return (
    <div className="flex flex-col h-full  lg:px-40 overflow-y-auto">
      <Navbar />
      <div className=" flex-1   grid grid-cols-6  py-5 ">
        ...
        <div className="col-span-4  flex items-center">
          <div className="scroll-about w-full ">
            <div className="text-[11px] space-y-4">
              ...
              <p>
                Currently working as a Full-Stack Developer, I’ve contributed to
                projects across the entire development lifecycle—from building
                RESTful APIs with NestJS and MongoDB to developing modern
                frontend experiences. I enjoy solving challenging problems,
                improving performance, and turning UI/UX concepts into reliable,
                production-ready features.
              </p>
              <p>
                Before getting into full-stack development, I spent years honing
                strong communication, leadership, and project-management skills,
                including leading a 19+ member team at AIESEC. These experiences
                help me collaborate effectively and bring structure, clarity,
                and initiative to the teams I work with.
              </p>
              <div>
                <p className="title-about-me">What can i bring to the table</p>
                <div className="space-y-4 pt-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    <p>
                      Communication developed through managing and coordinating
                      teams.
                    </p>
                  </div>
                  <div className="flex gap-2">
